...
class OutletsControllerTest < ActionController::TestCase
  ...
  test "should create outlet" do
    assert_difference('Outlet.count') do
      post :create, outlet: { description: @outlet.description, name: @outlet.name, user_id: @outlet.user_id }
    end
  ...
  test "should update outlet" do
    patch :update, id: @outlet, outlet: { description: @outlet.description, name: @outlet.name, user_id: @outlet.user_id }
    assert_redirected_to outlet_path(assigns(:outlet))
  end
