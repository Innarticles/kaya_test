...
class SaleItemsControllerTest < ActionController::TestCase
  ...
  test "should create sale_item" do
    assert_difference('SaleItem.count') do
      post :create, sale_item: { price: @sale_item.price, product_id: @sale_item.product_id, quantity: @sale_item.quantity, sale_id: @sale_item.sale_id }
    end
  ...
  test "should update sale_item" do
    patch :update, id: @sale_item, sale_item: { price: @sale_item.price, product_id: @sale_item.product_id, quantity: @sale_item.quantity, sale_id: @sale_item.sale_id }
    assert_redirected_to sale_item_path(assigns(:sale_item))
  end
