...
ActiveRecord::Schema.define(version: 20170308090741) do
  ...
  add_index "outlets", ["company_id"], name: "index_outlets_on_company_id", using: :btree
  add_index "outlets", ["user_id"], name: "index_outlets_on_user_id", using: :btree
  ...
  add_index "sales", ["outlet_id"], name: "index_sales_on_outlet_id", using: :btree
